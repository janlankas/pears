...
const anita_config = {
    ...
    socials: {
        ...
        'youtube' : {
            'url': 'https://www.youtube.com/@pearartproduction',
            'label': 'Yt.'
        },
    },
    ...
    image_drag_protection: false,

    l10n: {
        copyright: 'Copyright &copy; 2023. Všechna práva vyhrazena.',

        rcp_message: 'Kontextová nabídka není povolena',

        rcp_button: 'Rozumím!',

        b2t_label: 'Zpět nahoru'
    }
}
